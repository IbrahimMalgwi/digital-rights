                ...
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div>
                        <div className="flex items-center mb-4">
                            <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-accent-500 rounded-lg flex items-center justify-center font-bold text-white shadow-medium">
                                {siteContent.site?.name?.[0] || 'D'}
                            </div>
                            <span className="ml-3 font-display font-semibold text-white">
                        ...
                        <div className="flex space-x-3 mt-4">
                            {siteContent.site?.social && Object.entries(siteContent.site.social).slice(0, 3).map(([platform, url]) => (
                                <a
                                    ...
                                    className="w-8 h-8 bg-secondary-800 rounded-lg flex items-center justify-center text-secondary-400 hover:bg-gradient-to-br hover:from-primary-500 hover:to-accent-500 hover:text-white transition-all duration-200"
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-start">
                                <svg className="w-4 h-4 text-primary-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span className="text-secondary-300 hover:text-primary-400 transition-colors break-all">
                            ...
                            <li className="flex items-start">
                                ...
                                <span className="text-secondary-300 hover:text-primary-400 transition-colors">
